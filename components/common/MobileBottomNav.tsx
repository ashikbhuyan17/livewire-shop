      ...
      >
        <div className="grid grid-cols-6 gap-0.5">
          <Link
            ...
            className={cn(
              navItemClass,
              isHome ? 'text-headerBg' : 'text-gray-500 hover:text-gray-800',
            )}
          >
            <Home
            ...
            <span
              className={cn(
                labelClass,
                isHome && 'font-semibold text-headerBg',
              )}
            >
              Home
            </span>
          ...
          <Link
            ...
            className={cn(
              navItemClass,
              isAccount ? 'text-headerBg' : 'text-gray-500 hover:text-gray-800',
            )}
          >
            <User
              className="h-6 w-6 shrink-0"
                ...
                <ul className="grid gap-1">
                  {moreLinks.map(({ href, label, icon: Icon }) => (
                    <li key={href}>
                      ...
                      >
                        <Icon
                          className="h-5 w-5 shrink-0 text-headerBg"
                          aria-hidden
                        />
                        {label}
